package io.ferry.my.booking.config;
...
@EnableJpaRepositories(
		...
		basePackages = "io.ferry.my.booking.repo"
)
public class BookingDBConfig {
	...
	public PlatformTransactionManager postgresqlTransactionManager(@Qualifier("bookingEntityManager") EntityManagerFactory entityManagerFactory) {
